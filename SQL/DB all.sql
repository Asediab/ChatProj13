...
ALTER TABLE "client" ADD FOREIGN KEY ("id") REFERENCES "reservation" ("id_user");
...
ALTER TABLE "client" ADD FOREIGN KEY ("id") REFERENCES "chat_session" ("id_client");

ALTER TABLE "employe" ADD FOREIGN KEY ("id") REFERENCES "chat_session" ("id_employe");
...
ALTER TABLE "agencie" ADD FOREIGN KEY ("id") REFERENCES "employe" ("id_agencie");
